...
export default class CookieConsentSettingsModal extends SettingsModal {
    ...
    title() {
        return app.translator.trans('fof-cookie-consent.admin.settings.title');
    }
    ...
    form() {
        return [
            <div className="Form-group">
                ...
                <StringItem name="fof-cookie-consent.buttonText" setting={this.setting.bind(this)}>{app.translator.trans('fof-cookie-consent.admin.settings.buttonText')}</StringItem>
